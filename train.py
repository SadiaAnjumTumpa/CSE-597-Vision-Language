...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_name', type=str, default='haav_default')
    ...
    parser.add_argument('--dataset_root', type=str, default="/HAAV/datasets/") # Please enter dataset root path
    ...
    txt_ctx_filed = TxtCtxField(
        ctx_file="txt_ctx.hdf5", k=args.topk
    ) # please enter textual context path
    vis_ctx_filed = VisCtxField(
        ctx_file="vis_ctx.hdf5"
    ) # Please enter visual context path
    ...
    for e in range(args.num_epochs):
        # training epoch
        if args.stage == "xe":
#            # SAT: temporary subset
#            # Determine the number of samples to use 1000 samples
#            num_samples = 1000
#            
...
#            dataloader_train = DataLoader(
#                train_dataset, batch_size=args.bs, sampler= subset_sampler, num_workers=args.workers, drop_last=True
#            )
